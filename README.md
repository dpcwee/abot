...
В боте существует **`реферальная система`**: человек, которого Вы привели, может указать BEP20 кошелёк от Вашего аккаунта. Текущий процент, выплачиваемый пользователям от биржевой комиссии, полученных разработчиками, составляет: `11%`
