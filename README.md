...
* `signals` [y/n] — Принимать торговые сигналы с TradingView или POST запросов посредством вебхуков  
* `max_signals` [0 <= min <= 999] — Максимальное количество позиций, открытых по сигналам  
