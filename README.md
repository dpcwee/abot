...
* Ключ `stop_loss` (активируется командой ***--conf stop_loss ОТРИЦАТЕЛЬНОЕ_ЧИСЛО***) — Включить стоп-лосс для выхода из позиций, убыток по которым составляет ОТРИЦАТЕЛЬНОЕ_ЧИСЛО  
