...
Binance: [Регистрация по реферальной ссылке](https://accounts.binance.com/ru/register?ref=P6FHFEQ2)  
Referal ID: `P6FHFEQ2` (кэшбэк 10%)** 
...
1) Вводим команды `apt update`, а затем `apt install screen` и вводим Enter или Y, если этого требует терминал
