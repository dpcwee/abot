...
* `С` — Минимальная и максимальная разница времени бота и сервера биржи. Данные значения обозначают условных пинг: чем меньше, тем стабильнее работа бота  
* `Д` — Суточная дельта по парам из белого списка в процентах. Условное обозначение тренда рынка  
