...
> URL сервера для отправления сигналов, который рассылает сигналы индивидуальным ботам по веб-сокету: *https://212.8.246.121:443/tv/tv_hash*. **tv_hash** Вы найдёте в настроках API и Telegram (-k в главном меню A-Bot).   
...
> Код для отправки сигналов POST запросом на примере Python:  
    ...
    url = 'https://212.8.246.121:443/tv/tv_hash'
