...
Binance: [Регистрация по реферальной ссылке](https://accounts.binance.info/register?ref=C2GCPXJA) Referal ID: `C2GCPXJA`  
BitGet 20% cashback: [Регистрация по реферальной ссылке](https://partner.bitget.com/bg/asjq55421683623676390) Referal ID: `asjq5542`** 
