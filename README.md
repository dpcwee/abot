...
**Никаких других официальных сайтов с репозиториями и контактами, кроме GitHub, у проекта нет!**
...
* `perc_down` [%] — Изменение суточной цены актива, необходимое для его первой покупки (например -5)  
