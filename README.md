...
*[Расчёт усреднений](https://mega.nz/file/IUQ3ybrQ#hsaJ_fNY9JVCss-fFlBLnITqzUx7-sqdyBz1R5p7StU)* — таблица расчёта цены и объёма ордеров для усреднений от *[@dpcwee](https://t.me/dpcwee)*  
...
* Клшюч `row_timer` (активируется командой ***--conf row_timer ЧИСЛО***) — Сбрасывать множитель row_sell у позиции в случае, если её длина больше указанного времени в секундах (по умолчанию 3600)
