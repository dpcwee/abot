...
URL сервера для отправления сигналов, который рассылает сигналы индивидуальным ботам по веб-сокету: *https://212.8.246.121:443/tv/hash*.  
**hash** Вы найдёте в настроках API и Telegram (-k в главном меню A-Bot).   
