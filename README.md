...
**ВНИМАНИЕ! Бесплатно бот работает только на аккаунтах Binance, зарегистрированных по реферальной ссылке разработчиков. В связи с обновлением политики торговли по API на Binance от 23.08.2021, торговля по API будет возможна ТОЛЬКО на аккаунтах, прошедших промежуточную верификацию. По этому поводу вводится система оплаты за полезное использование бота. За каждую сделку, совершённую A-Bot при его использовании, будет взиматься дополнительная комиссия в размере 0.025%. Аккаунты, которые зарегистрированы по нашей реферальной ссылке, продолжат пользоваться инстурментом бесплатно.  
При первом запуске бота новым пользователям будет начислен бонус в размере 10$ на счёт аккаунта A-Bot.  
...
### Пополнение баланса:
![](./screen/img-23.png)  
Для работы бота на аккаунтах, зарегистрированных не по реферальной ссылке разработчиков, действует система полезной оплаты за совершённые сделки, которая составляет 0.025% от размера сделки бота. При первом запуске бота на аккаунте Binance пользователю начисляется бонус в размере 10$. В дальнейшем, в случае отсутствия денежных средств на аккаунте A-Bot, работа бота будет автоматически приостановлена, поэтому не забывайте следить за оставшимся балансом.  
Для пополнения баланса A-Bot Вам необходимо будет настроить Telegram-бота по ***[инструкции](https://abot-config.ru/help/telegram-bot)*** и пополнить баланс на желаемую Вами сумму в BUSD, но не меньше 10$, следуя указаниям к переводу.  
**Оплата через общий Telegram-бот soon...**  
...
* `pump_detector` [y/n] — Использовать детектор пампов для открытия/усреднения позиций? Если ***Y***, бот будет анализировать все монеты из разрешённого списка монет в реальном времени и, в случае обнаружения всплеска объёмов, доминации покупателей и роста цены актива, незамедлительно покупать монету  
