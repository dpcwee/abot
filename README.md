...
В боте существует **`реферальная система`**: человек, которого Вы привели, может указать BEP20 кошелёк от Вашего аккаунта. При этом Ваш аккаунт также должен быть зарегистрирован по реферальной ссылке разработчиков.
...
* `sell_cut` [y/n] — Уменьшать желаемую прибыль на монете по мере роста количества её усреднений. Если ***Y***, то новый sell_up будет рассчитываться, как **sell_up / (количество усреднений + 1)**  
...
* `progressive_max_pairs` [y/n] — Использовать прогрессивное уменьшение максимального количества пар. Если ***Y***, количество пар при включенной настройке **auto_trade_pairs** будет автоматически уменьшаться не только в зависимости от соотношения свободного и общего баланса, но и от количества открытых ордеров и суммарного количества их усреднений  
