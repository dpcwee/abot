...
*[Расчёт усреднений](https://mega.nz/file/ZZhDSYJD#LcSmcuRs4NcO3TVyNBuFKI9OeA3VkY9l2qAbi3D_gbw)* — таблица расчёта цены и объёма ордеров для усреднений от *[@dpcwee](https://t.me/dpcwee)*  
...
### TradingView:
Бот поддерживает работу с сигналами от TradingView. Вы можете подобрать/создать свой индикатор и посредством вебхуков отправлять команды A-Bot'у для работы с активами, который, в свою очередь, примет этот актив в работу по своим торговым алгоритмам и настройкам пользователя.  
Все ключи и значения сигнала должны быть в фигурных скобках **{}**.  
URL сервера для отправления сигналов, который рассылает сигналы индивидуальным ботам по веб-сокету: *https://212.8.246.121:443/tv/your_tv_hash*  
