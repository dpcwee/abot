...
![](./screen/img-12.png) — Ордер на покупку исполнился  
![](./screen/img-13.png) — Размещён ордер на продажу  
![](./screen/img-14.png) — Ордер на продажу исполнился, позиция закрылась  
...
![](./screen/img-18.png) — Полная продажа позиции по трейлингу  
