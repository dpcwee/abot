...
**При первом запуске бота каждому пользователю будет начислен бонус в размере 10$ на счёт аккаунта A-Bot.**  
...
* `-sat` — Продать все свободные или потерявшиеся монеты (со статусом SELL_ORDER и NO_ORDER)
